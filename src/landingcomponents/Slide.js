...
export const Slide = () => {
  ...
  const [isButtonHovered, setIsButtonHovered] = useState(false); // Tracks if the button is hovered
    ...
    <div>
      ...
      <div className="slideshow">
        ...
        >
          {images.map((item, idx) => (
            <div
              className={`slideHorse ${isButtonHovered ? "zoom" : ""}`}
              key={idx}
              style={{
        ...
        <div className="slideTools">
          ...
          />
          <img src={SlideL} alt="Left" id="slideL" />
          <img src={SlideR} alt="Right" id="slideR" />
            ...
            <div className="fixSlide">
              ...
              <div>
                ...
                <div className="fixBottom">
                  <div
                    className="fixBtn"
                    onMouseEnter={() => setIsButtonHovered(true)} // Start zoom on hover
                    onMouseLeave={() => setIsButtonHovered(false)} // Stop zoom on leave
                  >
                    PLAY NOW
                  </div>
                </div>
